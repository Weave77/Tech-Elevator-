        ...
        public static List<SelectListItem> States //{ get; } = new List<SelectListItem>()
        {
            get
            {
                return new List<SelectListItem>()
                {
                    ...
                    new SelectListItem { Text = "Nevada", Value = "N"},
                    ...
                    new SelectListItem { Text = "West Virigina", Value = "WV"},
                    new SelectListItem { Text = "Wisconson", Value = "WI"},
        ...
        public static List<SelectListItem> ActivityLevels
        {
            get
            {
                return new List<SelectListItem>()
                {
                    ...
                    new SelectListItem { Text = "Extremly Active"}
                };
            }
        }
    }
